...
require'./login sena/class/sessions.php';
$objses = new Sessions();
$objses->init();
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="login sena/user/profile.php"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="login sena/log_out.php"><i class="fa fa-fw fa-power-off"></i> Salir</a>
                        </li>
                    </ul>
                </li>
            </ul>
