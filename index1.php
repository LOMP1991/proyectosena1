        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="admin/lista_aprendiz.php"><i class="fa fa-fw fa-gear"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="admin/forms.php"><i class="fa fa-fw fa-edit"></i>Generar novedades</a>
                    </li>
                    <li>
                    ...
                    <div class="col-lg-15">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php  
                                $url = "http://localhost:8080/proyectosena/index1.php";
