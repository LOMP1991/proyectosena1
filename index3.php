    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> BIENVENIDO <?php echo " " . $_SESSION['usuario'];?><b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="admin/perfil.php"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="admin/indexAdmincontroller.php"><i class="fa fa-fw fa-edit"></i>Novedades Generadas </a>
                    </li>
                    <li>
                        <a href="admin/vistaaprendiz.php"><i class="fa fa-fw fa-edit"></i>Buscar y Generar Novedad</a>
                    </li>
                    <li>
                     <li>
                      ...
                      <li>
                    <a href="./admin/registroUsuario.php"><i class="fa fa-fw fa-edit"></i>Registro De Usuario</a>
                    </li>
                     </ul>
                    </li>
                </ul>
                    ...
                    <div class="col-lg-15">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php  
                                $url = "http://localhost:8080/proyectosena/index3.php";
...
?> 
        ...
        <div class="text-right">
            <a href="Admin/indexAdmincontroller.php">Registrar Novedades<i class="fa fa-arrow-circle-right" id="nuevo-novedad"></i></a>
        </div>
        </div>
        </div>
        </div>
                    <div class="col-lg-10">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-user fa-fw"></i> Control De Instructores</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                <?php  
...
$consulta_aprendiz = "SELECT * FROM tbl_instructores";
$rs_deaprendiz = $conn->query($consulta_aprendiz);
$num_total_registros =mysqli_num_rows($rs_deaprendiz );
...
if ($num_total_registros > 0) {
    ...
    $total_paginas = ceil($num_total_registros / $TAMANO_PAGINA);
    //pongo el numero de registros total, el tamaño de pagina y la pagina que se muestra
    echo '<h3>Total de Instructores: '.$num_total_registros .'</h3>';
    echo '<h3>En cada pagina de '.$TAMANO_PAGINA.' se muestra los Instructores registrados.</h3>';
    echo '<h3>Mostrando la pagina '.$pagina.' de ' .$total_paginas.' paginas.</h3>';
    $consulta = "SELECT * FROM tbl_instructores tf INNER JOIN tbl_fichas t ON t.id_ficha = tf.id_ficha  ORDER BY id_instructor LIMIT ".$inicio."," . $TAMANO_PAGINA;
    $rs =$conn->query($consulta);
      echo "<table class='table table-bordered table-hover table-striped'>";
            echo  '<thead>';
                echo '<tr>';
            ...
            echo '<td>'. $row['primer_nombre'].'</td>';
             ...
             echo '<td>'.$row['celular_instructor'].'</td>';
