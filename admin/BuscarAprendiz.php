...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="forms.php"><i class="fa fa-fw fa-edit"></i>Mis Novedades Generadas</a>
                    </li>
                    <li class="active">
                        <a href="BuscarAprendiz.php"><i class="fa fa-fw fa-edit"></i>Buscar y Generar Novedad</a>
                    </li>
                        <li>
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                           <li>
                                <i class="fa fa-desktop"></i>  <a href="../admin/index1Instructor">BIENVENIDA</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="../admin/index1Instructor.php"> Novedades Generadas</a> 
                            </li>
                            <li>
                                <i class="fa fa-search"></i> <a href="../admin/BUscarAprendiz.php">Buscar y Generar novedad</a>  
                            </li>
                        </ol>
                    </div>
                </div>
        <div class="row">
         <div class="col-lg-5">
            <div class="form-group"><input class="form-control" type="text" placeholder="Busca un Aprendiz Por: Nombre :" id="bs-proapr"/>
            </div>
          </div>
