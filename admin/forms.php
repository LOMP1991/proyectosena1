        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="../admin/forms.php"><i class="fa fa-fw fa-edit"></i>Mis Novedades Registradas</a>
                    </li>
                    <li>
                        <a href="BuscarAprendiz.php"><i class="fa fa-fw fa-edit"></i>Buscar Y Generar Novedades</a>
                    </li>
                    <li>
                         <a href="registroAprendiz2.php">Registro De Aprendiz</a>
                    </li>   
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i><a href="../admin/forms.php">Novedades Registradas</a>
                            </li>
                            <li>
                                <i class="fa fa-edit"></i>Buscar Y Registrar Novedades
                            </li>
                            <li>
                                <i class="fa fa-edit"></i>Registrar Aprendiz
                            </li>
                        </ol>
                    </div>
                </div>
...
echo '<table class="table table-striped table-condensed table-hover">
     ...
     foreach ($row as $sth1 => $registro2) {
         # code...
     
        echo '<tr>
                <td>'.$registro2['primer_nombre'].' '.$registro2['segundo_nombre'].' '.$registro2
                 
                 ['primer_apellido'].' '.$registro2['segundo_apellido'].' </td>
                <td> '.$registro2['primer_nombre1'].' '.$registro2['segundo_nombre2'].' '.$registro2['primer_apellido1'].' '.$registro2['segundo_apellido2'].'</td>
                <td>'.$registro2['descripcion_tipo_novedad'].' </td>
                <td> '.$registro2['descripcion_motivo'].'</td>
                <td>'.$registro2['nombre_complejo'].' </td>
                <td>'.$registro2['direccion_complejo'].' </td>
...
echo '</table>';
    ...
    <div class="col-lg-8">
        <div class="form-group">
            ...
            <input class="form-control" id="descripcion-tipo-novedad" name="descripcion_tipo_novedad" value="<?php echo $registro2[0]['descripcion_tipo_novedad'];?>"/>
        </div>
        <div class="form-group">
        <label> Motivo </label>
