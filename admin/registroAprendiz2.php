        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="buscarAprendiz"><i class="fa fa-fw fa-edit"></i>Buscar y Generar novedad</a>
                    </li>    
                    <li>
                        <a href="registroAprendiz2.php"><i class="fa fa-fw fa-edit"></i>Registro De Aprendiz</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
