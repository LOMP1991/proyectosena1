        ...
        <div class="row">
         ...
         <div class="form-group">
          ...
          require'class/database.php';
           ...
           $sth1 = $objData->prepare('SELECT * FROM tbl_novedades NM INNER JOIN tbl_motivo O ON O.id_motivo=NM.id_motivo INNER JOIN tbl_tipo_novedades T ON NM.id_tipo_novedad=t.id_tipo_novedad  WHERE id_instructor=:id_instructor');
